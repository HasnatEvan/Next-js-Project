    ...
    <div className="bg-white min-h-screen px-6 py-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12">
        ...
        <div className="flex-1 bg-white p-8 rounded-lg shadow-lg border border-gray-200">
          <h1 className="text-3xl font-extrabold text-[#3972C1] mb-8 text-center md:text-left">
        ...
        <aside className="flex-1 bg-gray-50 p-8 rounded-lg shadow-md border border-gray-200 text-gray-700">
          <h2 className="text-2xl font-semibold mb-6 border-b text-center border-gray-300 pb-3">
            Room Details
          </h2>

          <p className="mb-3">
            <strong className="font-medium text-gray-900">Room Name:</strong>{" "}
            {data.roomName}
          </p>
          <p className="mb-3">
            <strong className="font-medium text-gray-900">Room Type:</strong>{" "}
            {data.roomType}
          </p>
          <p className="mb-3">
            <strong className="font-medium text-gray-900">Beds:</strong> {data.beds}
          </p>
          <p className="mb-6">
            <strong className="font-medium text-gray-900">Price per night:</strong>{" "}
